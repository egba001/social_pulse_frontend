    ...
    return (
        <div className="w-full flex justify-between items-center py-10 px-6 lg:px-12">
            ...
            <div
                ...
                <Link to='/login' className='outline-none block mx-auto text-green w-[15rem] rounded-xl active:bg-green active:text-white active:border-0 py-2 cursor-pointer border  border-green text-center'>Login</Link>
            </div>
