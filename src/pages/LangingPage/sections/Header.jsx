            ...
            style={{
                ...
                <div className="container mx-auto px-6 lg:px-24 pt-16 lg:pt-24">
                    <h1 className="text-3xl lg:text-5xl font-bold lg:font-extrabold text-dark mb-6">
                        <Typewriter
                            words={['Gather insights about your brand', 'Understand and engage your audience', 'Maintain your brand reputation']}
                            loop={false}
                            cursor
                            cursorStyle='|'
                            typeSpeed={150}
                    ...
                    <h2 className='font-normal text-lg mb-6 text-[#393939]'>Stay ahead on the social space with SocialPulse. Get access reviews, mentions and feedback about your brand across social media.</h2>
                    <form className='lg:w-[70%] w-full mx-auto'>
                        <div className='w-full border mb-6 border-[#CFCFCF] py-2 px-3 rounded-md'>
                            <input type='email' className='w-full outline-none' placeholder='Enter Email Address' />
                        </div>
                        <div className='w-[60%] lg:w-[35%] mx-auto'>
                            <button type='submit' className='bg-green rounded-md text-white w-full py-2 text-center'>Get Started</button>
                        </div>
                    </form>
                </div>
