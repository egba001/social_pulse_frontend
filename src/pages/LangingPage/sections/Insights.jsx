...
const Insights = () => {
    ...
    return (
        <SectionsLayout>
            <div className="flex flex-col lg:flex-row pb-16 lg:py-36 justify-between items-center w-full">
                <img src={insights} alt="chart" data-aos="fade-right" data-aos-duration="1500" className='drop-shadow lg:w-[35%] mb-8 lg:mb-0' />
