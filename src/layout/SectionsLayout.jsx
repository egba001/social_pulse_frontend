...
const SectionsLayout = ({children}) => {
    return (
        <section className="relative font-red border-b py-16 pt-8 lg:pt-0 border-b-purple-300 flex items-center overflow-hidden">
            <div className="absolute hidden lg:block -top-12 -right-12 lg:-top-52 lg:right-5 w-[280px] h-[280px] lg:w-[350px] lg:h-[350px] lg:bg-opacity-40 bg-opacity-30 bg-[#5D269D] rounded-full blur"></div>
